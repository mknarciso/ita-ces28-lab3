...
public class WeddingInviteLetterBR implements LetterBuilder{
    private Person bFather_, bMother_, gFather_, gMother_, bride_, groom_, receiver_;
    private Date date_;
    private Address cerimonyAddr_, receiverAddr_;
    WeddingInviteLetterBR(){}
    WeddingInviteLetterBR(Person bFather, Person bMother, Person gFather, Person gMother,
    ...
    public String body() {
    return "Temos a honra de convidá-lo para o casamento de nossos filhos\n  "+
    bride_.name() + " & "+ groom_.name() +"\n\n A cerimônia ocorrerá na \n" + cerimonyAddr_.toPrint() +
    " em " + date_.toPrint() + "\n\n";
    }
    public String conclusion() {
    return "Por favor confirme presença:" + bride_.phone();
    }

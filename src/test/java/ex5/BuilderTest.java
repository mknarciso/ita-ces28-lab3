...
public class BuilderTest {
    ...
    public void checkComercialLetter(){
        ComercialLetterEnglish comercial = new ComercialLetterEnglish(p1, p2,
    ...
    public void checkLoveLetter(){
        LoveLetterEnglish love = new LoveLetterEnglish(p1, p2, city, content, date);
    ...
    public void checkInviteLetter(){
        WeddingInviteLetterEnglish invite = new WeddingInviteLetterEnglish

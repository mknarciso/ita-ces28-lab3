...
public class WeddingInviteLetterEnglish extends Letter implements LetterBuilder {
	private Person bFather_, bMother_, gFather_, gMother_, bride_, groom_, receiver_;
    private Date date_;
    private Address cerimonyAddr_, receiverAddr_;
    WeddingInviteLetterEnglish(){}
    WeddingInviteLetterEnglish(Person bFather, Person bMother, Person gFather, Person gMother,
